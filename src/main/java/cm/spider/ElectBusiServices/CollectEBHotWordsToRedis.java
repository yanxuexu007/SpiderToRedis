...
public class CollectEBHotWordsToRedis {
	...
	public CollectEBHotWordsToRedis(){
		not="赌博,奇葩,六合,假牌,假证,迷药,杀人,放火,仿真枪,成人网,成人用品,性用品,抢劫,偷盗,枪支,弹药,假冒,事变,政变,老千,法轮,全能神,全能教,邪教,"
				+ "冰毒,摇头丸,大麻,造反,色吧,鸡鸡,手淫,性吧,性福,性欲,狠狠插,红灯区,卖淫,淫乱,爆乳,约炮,色情,情色,吞精,精液,艳照,淫荡,勾引,"
				+ "自慰,爱爱,做爱,偷情,偷性,交配,撸管,色系,鸡巴,飞机杯,车震,露阴,震动棒,性用品,假阳具,龟头,毒品,吸毒,叫鸡,洗钱,黑钱,赌钱,性骚扰,裸奔,裸照,轮奸,强奸,色图,淫娃,"
...
//	}
	...
	public TreeSet<String> collectAllEletronicBusinessHotWords(){
		...
		try{
			...
			{
				//判断是会否为无效信息
				unvalid=fillterUnValidWords(str);
				if(unvalid==false){
